...
public class OrganizationsPipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.fromSource(source, org.apache.flink.api.common.eventtime.WatermarkStrategy.noWatermarks(), "Kafka Organizations Source");
        ...
        SinkFunction<Organization> starRocksSink = JdbcSink.sink(
                "INSERT INTO iceberg.rzdm_test.stg_organizations (" +
        ...
        DataStream<Organization> filteredStream = eventStream.filter(new FilterFunction<Organization>() {
            @Override
            public boolean filter(Organization organization) throws Exception {
                return organization != null;
            }
        });
        
        // Add the StarRocks sink
        filteredStream.addSink(starRocksSink);
