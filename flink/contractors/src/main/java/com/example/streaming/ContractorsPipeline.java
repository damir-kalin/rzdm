...
public class ContractorsPipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.fromSource(source, org.apache.flink.api.common.eventtime.WatermarkStrategy.noWatermarks(), "Kafka Contractors Source");
        ...
        SinkFunction<Contractor> starRocksSink = JdbcSink.sink(
                "INSERT INTO iceberg.rzdm_test.stg_contractors (" +
        ...
        DataStream<Contractor> filteredStream = eventStream.filter(new FilterFunction<Contractor>() {
            @Override
            public boolean filter(Contractor contractor) throws Exception {
