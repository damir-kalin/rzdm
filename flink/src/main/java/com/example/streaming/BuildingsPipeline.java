...
public class BuildingsPipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
                ...
                .setTopics("sys__mis__esud_rzdm._data_99099.fdb.BUILDINGS")
                .setGroupId("flink-buildings-consumer-group")
                .setStartingOffsets(OffsetsInitializer.earliest())
                .setValueOnlyDeserializer(new SimpleStringSchema())
                .build();

        DataStream<String> stream = env
                .fromSource(source, WatermarkStrategy.noWatermarks(), "Kafka Buildings Source")
                .name("Kafka Buildings Source")
                .uid("kafka-buildings-source");
        ...
        String insertSql = "INSERT INTO iceberg.rzdm_test.stg_buildings (" +
        ...
        DataStream<RawData> filteredStream = eventStream
                .filter(Objects::nonNull)
                .name("Filter null buildings")
                .uid("filter-buildings");
        ...
        filteredStream
                ...
                .uid("buildings-jdbc-sink")
                .setParallelism(1);

        env.execute("Buildings Streaming Pipeline");
    }
    ...
    private static StreamExecutionEnvironment createExecutionEnvironment() {
        ...
        env.configure(config, BuildingsPipeline.class.getClassLoader());
