...
public class ChairsPipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
                ...
                .setTopics("sys__mis__esud_rzdm._data_99099.fdb.CHAIRS")
                .setGroupId("flink-chairs-consumer-group")
                .setStartingOffsets(OffsetsInitializer.earliest())
                .setValueOnlyDeserializer(new SimpleStringSchema())
                .build();

        DataStream<String> stream = env
                .fromSource(source, WatermarkStrategy.noWatermarks(), "Kafka Chairs Source")
                .name("Kafka Chairs Source")
                .uid("kafka-chairs-source");
        ...
        String insertSql = "INSERT INTO iceberg.rzdm_test.stg_chairs (" +
        ...
        filteredStream
                ...
                .uid("chairs-jdbc-sink")
                .setParallelism(1);

        env.execute("Chairs Streaming Pipeline");
    }
    ...
    private static StreamExecutionEnvironment createExecutionEnvironment() {
        ...
        env.configure(config, ChairsPipeline.class.getClassLoader());
